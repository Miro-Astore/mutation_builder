...
mutator -psf build_files/prot.psf -pdb build_files/prot.pdb -o build_files/mutated_prot -ressegname SEGNAME -resid RESID -mut MUTATENAME
...
foreach name $names {
	...
	$ionsel writepsf build_files/$name.psf
	$ionsel writepdb build_files/$name.pdb
}
mol delete all 
foreach name $names {
...
set sel [atomselect top "not ions"]
